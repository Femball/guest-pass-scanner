ALTER TABLE public.member_cards ADD COLUMN IF NOT EXISTS valid_until date;
...
AS $$
  SELECT mc.card_uid, mc.first_name, mc.last_name, pc.name, pc.logo_url, mc.valid_until
